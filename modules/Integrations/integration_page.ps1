$ADCard =  New-UDInput -Title "AD Info" -Content {
            ...
            New-UDInputAction -Content @(
                Invoke-Sqlcmd -ServerInstance $cache:sql_instance -Database $cache:db_name -Query "update template_configs set active = 'yes', variablename = '$Varname', username = '$Username', password = '$Password', domainname = '$Domainname' where template_name = '$TemplateType'"
...
$CylanceCard =  New-UDInput -Title "Cylance Info" -Content {
            ...
            New-UDInputAction -Content @(
                Invoke-Sqlcmd -ServerInstance $cache:sql_instance -Database $cache:db_name -Query "UPDATE template_configs SET active = 'yes', variablename = '$Varname', apikey = '$apikey'  WHERE template_name = '$TemplateType'"
...
$VMwareCard =  New-UDInput -Title "VMWare Info" -Content {
            ...
            New-UDInputAction -Content @(
                ...
                Invoke-Sqlcmd -ServerInstance $cache:sql_instance -Database $cache:db_name -Query "update template_configs set active = 'yes', username = '$Username', variablename = '$Varname', password = '$Password', clustername = '$ClusterName' where template_name = '$TemplateType'"
